...
try {
    ...
    if ($e->getCode() == 1062) {
        $message = "<form method='post' action='/student070/dwes/confirmations/confirmation-reviews-update.php'>
                ...
                <a href='/student070/dwes/pages/reservations.php'><button type='button'>No</button></a>
            </form>";
    } else {
