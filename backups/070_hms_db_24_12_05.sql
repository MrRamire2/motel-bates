...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2024 a las 14:48:09
...
DROP TABLE IF EXISTS `070_reservations`, `070_rooms`, `070_customers`, `070_users` ,`070_employees` ,`070_employees_positions` , `070_payments`, `070_room_category`, `070_rooms_view`, `070_reservations_view`, `070_users_view`, `070_employees_view`;
...
(6, 1, 10, '2024-12-01', '2024-12-03', 110.00, '', 'booked'),
...
(62, 1, 11, '2024-11-20', '2024-11-23', 155.00, '', 'booked'),
(63, 20, 3, '2024-11-19', '2024-11-22', 90.00, '', 'cancelled'),
(64, 25, 11, '2024-11-28', '2024-11-30', 150.00, NULL, 'booked'),
(65, 25, 10, '2024-12-28', '2024-12-30', 150.00, NULL, 'booked');
...
(1, 1, NULL, 'Juan', 'Pérez', '12345678A', 'juan.perez@example.com', 'pass1234', '555123456', '1985-03-15', 'customer', 'active', '/images/users/Juan_Pérez_1985-03-15.jpg'),
(2, 2, NULL, 'María', 'Gómez', '23456789B', 'maria.gomez@example.com', 'pass1234', '555234567', '1990-06-25', 'customer', 'active', '/images/users/María_Gómez_1990-06-25.jpg'),
(3, 3, NULL, 'Carlos', 'Lopez', '34567890C', 'carlos.lopez@example.com', 'pass1234', '555345678', '1992-09-10', 'customer', 'active', '/images/users/Carlos_Lopez_1992-09-10.jpg'),
(4, 4, NULL, 'Ana', 'Martínez', '45678901D', 'ana.martinez@example.com', 'pass1234', '555456789', '1988-11-12', 'customer', 'active', '/images/users/Ana_Martínez_1988-11-12.jpg'),
(5, 5, NULL, 'Luis', 'Fernandez', '56789012E', 'luis.fernandez@example.com', 'pass1234', '555567890', '1993-01-05', 'customer', 'active', '/images/users/Luis_Fernandez_1993-01-05.jpg'),
(6, 6, NULL, 'Isabel', 'Ramirez', '67890123F', 'isabel.ramirez@example.com', 'pass1234', '555678901', '1987-04-22', 'customer', 'active', '/images/users/Isabel_Ramirez_1987-04-22.jpg'),
(7, 7, NULL, 'Jorge', 'Hernandez', '78901234G', 'jorge.hernandez@example.com', 'pass1234', '555789012', '1995-02-15', 'customer', 'active', '/images/users/Jorge_Hernandez_1995-02-15.jpg'),
(8, 8, NULL, 'Lucia', 'Mendoza', '89012345H', 'lucia.mendoza@example.com', 'pass1234', '555890123', '1983-08-19', 'customer', 'active', '/images/users/Lucia_Mendoza_1983-08-19.jpg'),
(9, 9, NULL, 'Raúl', 'Morales', '90123456I', 'raul.morales@example.com', 'pass1234', '555901234', '1990-05-30', 'customer', 'active', '/images/users/Raúl_Morales_1990-05-30.jpg'),
(10, 10, NULL, 'Chloe', 'Decker', '01234567J', 'sara.castillo@example.com', 'pass1234', '555012345', '1992-07-21', 'customer', 'inactive', '/images/users/Chloe_Decker_1992-07-21.jpg'),
(11, 26, NULL, 'David', 'Ortega', '12345012K', 'david.ortega@example.com', 'pass1234', '555123450', '1994-10-13', 'customer', 'inactive', '/images/users/David_Ortega_1994-10-13.jpg'),
(12, 12, NULL, 'Elena', 'Nuñez', '23456023L', 'elena.nunez@example.com', 'pass1234', '555234560', '1989-12-08', 'customer', 'active', '/images/users/Elena_Nuñez_1989-12-08.jpg'),
(13, 13, NULL, 'Victor', 'Flores', '34567034M', 'victor.flores@example.com', 'pass1234', '555345670', '1993-06-17', 'customer', 'active', '/images/users/Victor_Flores_1993-06-17.jpg'),
(14, 14, NULL, 'Clara', 'Vargas', '45678045N', 'clara.vargas@example.com', 'pass1234', '555456780', '1988-03-03', 'customer', 'active', '/images/users/Clara_Vargas_1988-03-03.jpg'),
(15, 15, NULL, 'Pablo', 'Cruz', '56789056O', 'pablo.cruz@example.com', 'pass1234', '555567890', '1986-11-29', 'customer', 'active', '/images/users/Pablo_Cruz_1986-11-29.jpg'),
(16, 3, 1, 'Juan', 'Pérez', '12345678A', 'juan.perez@example.com', 'password123', '555123456', '1985-03-15', 'customer', 'active', '/images/users/Juan_Pérez_1985-03-15.jpg'),
(17, 4, 2, 'María', 'Gómez', '23456789B', 'maria.gomez@example.com', 'password123', '555234567', '1990-06-25', 'customer', 'active', '/images/users/María_Gómez_1990-06-25.jpg'),
(18, 5, 3, 'Carlos', 'Lopez', '34567890C', 'carlos.lopez@example.com', 'password123', '555345678', '1992-09-10', 'customer', 'active', '/images/users/Carlos_Lopez_1992-09-10.jpg'),
(19, 6, 4, 'Ana', 'Martínez', '45678901D', 'ana.martinez@example.com', 'password123', '555456789', '1988-11-12', 'customer', 'active', '/images/users/Ana_Martínez_1988-11-12.jpg'),
(20, 7, 5, 'Luis', 'Fernandez', '56789012E', 'luis.fernandez@example.com', 'password123', '555567890', '1993-01-05', 'customer', 'active', '/images/users/Luis_Fernandez_1993-01-05.jpg'),
(21, NULL, 16, 'Ricardo', 'Sánchez', '56789012A', 'ricardo.sanchez@example.com', 'pass5678', '555678901', '1991-07-11', 'customer', 'active', '/images/users/Ricardo_Sánchez_1991-07-11.jpg'),
(22, NULL, 17, 'Patricia', 'Jiménez', '67890123B', 'patricia.jimenez@example.com', 'pass5678', '555789012', '1990-09-25', 'customer', 'active', '/images/users/Patricia_Jiménez_1990-09-25.jpg'),
(23, NULL, 18, 'Daniela', 'Morales', '78901234C', 'daniela.morales@example.com', 'pass5678', '555890123', '1992-01-18', 'customer', 'active', '/images/users/Daniela_Morales_1992-01-18.jpg'),
(24, NULL, 19, 'Fernando', 'Ruiz', '89012345D', 'fernando.ruiz@example.com', 'pass5678', '555901234', '1989-03-22', 'customer', 'active', '/images/users/Fernando_Ruiz_1989-03-22.jpg'),
(25, NULL, 20, 'Olguita', 'Fernández', '90123456E', 'olga.fernandez@example.com', 'pass5678', '555012345', '1993-11-05', 'customer', 'active', '/images/users/Olguita_Fernández_1993-11-05.jpg'),
(26, 18, NULL, 'Jhonatan', 'Ramirez', '12345678Y', 'j.ramirezap@gmail.com', '12345678a', '234545645', '2000-11-29', 'admin', 'active', '/images/users/Jhonatan_Ramirez_2000-11-29.jpg'),
(27, 18, NULL, 'Enrique', 'Enrique', '12345678e', 'enrique@gmail.com', 'dwesteacher', '123456789', '1965-12-01', 'admin', 'active', '/images/users/default.jpg');
...
DROP VIEW IF EXISTS `070_users_view`;
CREATE VIEW `070_users_view`  AS SELECT `u`.`user_id` AS `user_id`, `u`.`user_forename` AS `user_forename`, `u`.`user_surname` AS `user_surname`, `u`.`user_nif` AS `user_nif`, `u`.`user_email` AS `user_email`, `u`.`user_password` AS `user_password`, `u`.`user_phone` AS `user_phone`, `u`.`user_birthday` AS `user_birthday`, `u`.`user_rol` AS `user_rol`, `u`.`user_status` AS `user_status`, `u`.`user_image_url` AS `user_image_url`, `c`.`customer_id` AS `customer_id`, `c`.`customer_requirements` AS `customer_requirements`, `e`.`employee_id` AS `employee_id`, `e`.`date_hiring` AS `date_hiring`, `e`.`position_id` AS `position_id`, `e`.`position_name` AS `position_name`, `e`.`position_salary` AS `position_salary` FROM ((`070_users` `u` left join `070_customers` `c` on(`u`.`customer_id` = `c`.`customer_id`)) left join `070_employees_view` `e` on(`u`.`employee_id` = `e`.`employee_id`)) ;
