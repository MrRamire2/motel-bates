...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2025 a las 21:14:45
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `070_select_category_name_per_price` ()   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `070_users_verify` (IN `var_email` VARCHAR(50), IN `var_password` VARCHAR(20))   BEGIN
    SELECT *
    FROM `070_users_view`
...
CREATE TABLE `070_reviews` (
  ...
  `room_category_id` enum('1','2','3','') NOT NULL,
