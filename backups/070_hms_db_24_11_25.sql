...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2024 a las 14:02:50
...
INSERT INTO `070_users` (`user_id`, `employee_id`, `customer_id`, `user_forename`, `user_surname`, `user_nif`, `user_email`, `user_password`, `user_phone`, `user_birthday`, `user_status`) VALUES
(1, 1, NULL, 'Juan', 'Pérez', '12345678A', 'juan.perez@example.com', 'pass1234', '555123456', '1985-03-15', 'active'),
(2, 2, NULL, 'María', 'Gómez', '23456789B', 'maria.gomez@example.com', 'pass1234', '555234567', '1990-06-25', 'active'),
(3, 3, NULL, 'Carlos', 'Lopez', '34567890C', 'carlos.lopez@example.com', 'pass1234', '555345678', '1992-09-10', 'active'),
(4, 4, NULL, 'Ana', 'Martínez', '45678901D', 'ana.martinez@example.com', 'pass1234', '555456789', '1988-11-12', 'active'),
(5, 5, NULL, 'Luis', 'Fernandez', '56789012E', 'luis.fernandez@example.com', 'pass1234', '555567890', '1993-01-05', 'active'),
(6, 6, NULL, 'Isabel', 'Ramirez', '67890123F', 'isabel.ramirez@example.com', 'pass1234', '555678901', '1987-04-22', 'active'),
(7, 7, NULL, 'Jorge', 'Hernandez', '78901234G', 'jorge.hernandez@example.com', 'pass1234', '555789012', '1995-02-15', 'active'),
(8, 8, NULL, 'Lucia', 'Mendoza', '89012345H', 'lucia.mendoza@example.com', 'pass1234', '555890123', '1983-08-19', 'active'),
(9, 9, NULL, 'Raúl', 'Morales', '90123456I', 'raul.morales@example.com', 'pass1234', '555901234', '1990-05-30', 'active'),
(10, 10, NULL, 'Chloe', 'Decker', '01234567J', 'sara.castillo@example.com', 'pass1234', '555012345', '1992-07-21', 'inactive'),
(11, 26, NULL, 'David', 'Ortega', '12345012K', 'david.ortega@example.com', 'pass1234', '555123450', '1994-10-13', 'inactive'),
(12, 12, NULL, 'Elena', 'Nuñez', '23456023L', 'elena.nunez@example.com', 'pass1234', '555234560', '1989-12-08', 'active'),
(13, 13, NULL, 'Victor', 'Flores', '34567034M', 'victor.flores@example.com', 'pass1234', '555345670', '1993-06-17', 'active'),
(14, 14, NULL, 'Clara', 'Vargas', '45678045N', 'clara.vargas@example.com', 'pass1234', '555456780', '1988-03-03', 'active'),
(15, 15, NULL, 'Pablo', 'Cruz', '56789056O', 'pablo.cruz@example.com', 'pass1234', '555567890', '1986-11-29', 'active'),
(16, 3, 1, 'Juan', 'Pérez', '12345678A', 'juan.perez@example.com', 'password123', '555123456', '1985-03-15', 'active'),
(17, 4, 2, 'María', 'Gómez', '23456789B', 'maria.gomez@example.com', 'password123', '555234567', '1990-06-25', 'active'),
(18, 5, 3, 'Carlos', 'Lopez', '34567890C', 'carlos.lopez@example.com', 'password123', '555345678', '1992-09-10', 'active'),
(19, 6, 4, 'Ana', 'Martínez', '45678901D', 'ana.martinez@example.com', 'password123', '555456789', '1988-11-12', 'active'),
(20, 7, 5, 'Luis', 'Fernandez', '56789012E', 'luis.fernandez@example.com', 'password123', '555567890', '1993-01-05', 'active'),
(21, NULL, 16, 'Ricardo', 'Sánchez', '56789012A', 'ricardo.sanchez@example.com', 'pass5678', '555678901', '1991-07-11', 'active'),
(22, NULL, 17, 'Patricia', 'Jiménez', '67890123B', 'patricia.jimenez@example.com', 'pass5678', '555789012', '1990-09-25', 'active'),
(23, NULL, 18, 'Daniela', 'Morales', '78901234C', 'daniela.morales@example.com', 'pass5678', '555890123', '1992-01-18', 'active'),
(24, NULL, 19, 'Fernando', 'Ruiz', '89012345D', 'fernando.ruiz@example.com', 'pass5678', '555901234', '1989-03-22', 'active'),
(25, NULL, 20, 'Olga', 'Fernández', '90123456E', 'olga.fernandez@example.com', 'pass5678', '555012345', '1993-11-05', 'active'),
(26, 18, NULL, 'Jhonatan', 'Ramirez', '12345678Y', 'j.ramirezap@gmail.com', '12345678a', '234545645', '2000-11-29', 'active');
...
--
ALTER TABLE `070_reservations`
  ADD CONSTRAINT `fk_customer` FOREIGN KEY (`user_id`) REFERENCES `070_customers` (`customer_id`),
