...
require($ROOT . '/student070/dwes/db/db-extras-add.php');
?>
...
<body>
    ...
    <main>
        <h1><?php echo $_SESSION["extra_message"]; ?></h1>

        <a href="/student070/dwes/forms/form-extras-reservations-update-select-id.php">Update another reservation</a>
    </main>
