...
require($ROOT . '/motel-bates/db/db-employees-insert.php');
require($ROOT . '/motel-bates/db/db-users-update-employee.php');
?>
...
<body>
    ...
    <main>
        ...
        <a href="/motel-bates/forms/form-employees-insert.php">Insert a new employee</a>
    </main>
