...
require($ROOT . '/student070/dwes/db/db-employees-insert.php');
require($ROOT . '/student070/dwes/db/db-users-update-employee.php');
?>
...
<body>
    ...
    <main>
        ...
        <a href="/student070/dwes/forms/form-employees-insert.php">Insert a new employee</a>
    </main>
