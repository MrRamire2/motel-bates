...
require($ROOT . '/student070/dwes/db/db-reservations-delete.php');
?>
...
<body>
  ...
  <main>
    <h1><?php echo isset($message) ? $message : 'Reservation not removed'; ?></h1>

    <a href="/student070/dwes/forms/form-reservations-delete-select-id.php">Delete another reservation</a>
  </main>
