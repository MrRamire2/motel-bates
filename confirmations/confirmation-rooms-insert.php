...
require($ROOT . '/student070/dwes/db/db-rooms-insert.php');
?>
...
<body>
    ...
    <main>
        <h1><?php echo isset($message) ? $message : 'Room not entered'; ?></h1>

        <a href="/student070/dwes/forms/form-rooms-insert.php">Insert a new room</a>
    </main>
